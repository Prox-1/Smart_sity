...
Коротко: проект для моделирования городской среды на SUMO с агентами, метриками и модулем управления авариями/препятствиями. Поддерживается запуск симуляции, обучение/тестирование агентов и визуализация результатов. Главной целью проекта является создание агентов регулировки светофоров для улучшения пропускной способности города.
...
- Бот аварий (генерация инцидентов в gui через геолокацию в Telegram):
```bash
